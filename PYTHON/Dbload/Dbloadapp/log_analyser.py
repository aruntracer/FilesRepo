import os
from Dbloadapp.properties import airport_logs_dir,airport_file_name,airport_col_name
from Dbloadapp.my_functions import find_nth_character,remove_numbers,get_splitter,get_formatted_date
import csv
#import cx_Oracle
